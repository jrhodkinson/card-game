...
public class PlayerDto {
    ...
    private PlayerDto(String username, int health, List<StructureDto> structures, List<CardDto> hand, int deckSize, int discardPileSize) {
    ...
    public static PlayerDto fromPlayer(Player player) {
        return new PlayerDto(
                ...
                player.getHand().stream().map(CardDto::fromCard).collect(toList()),
                player.getDeck().size(),
